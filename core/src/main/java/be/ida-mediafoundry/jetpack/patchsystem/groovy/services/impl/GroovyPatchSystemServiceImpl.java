package be.ida-mediafoundry.jetpack.patchsystem.groovy.services.impl;

import be.ida-mediafoundry.jetpack.patchsystem.JetpackConstants;
import be.ida-mediafoundry.jetpack.patchsystem.groovy.models.GroovyPatchFile;
import be.ida-mediafoundry.jetpack.patchsystem.groovy.models.GroovyPatchResult;
import be.ida-mediafoundry.jetpack.patchsystem.models.PatchFileWithResultResource;
import be.ida-mediafoundry.jetpack.patchsystem.groovy.utils.PatchUtils;
import be.ida-mediafoundry.jetpack.patchsystem.models.*;
import be.ida-mediafoundry.jetpack.patchsystem.groovy.repositories.GroovyPatchResultRepository;
import be.ida-mediafoundry.jetpack.patchsystem.groovy.repositories.GroovyPatchFileRepository;
import be.ida-mediafoundry.jetpack.patchsystem.groovy.services.GroovyPatchSystemService;
...
public class GroovyPatchSystemServiceImpl implements GroovyPatchSystemService {
    ...
    private static final String DEFAULT_SERVICE = "be.ida-mediafoundry.jetpack.patch-system.core";
